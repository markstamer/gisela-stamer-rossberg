...
var slideWidth;var slideHeight;var frameHeight;var frameWidth;var scroller;var slideshow;var thumbnails;var hud;var thumbMatte=89;var pickerHeight=100;var browser;var baseURL="IWeb_Files/Icons/";var windowWidth=800;var windowHeight=800;function initSlideshow(imageStream,index,parameters){browser=new BrowserDetectLite();if(checkBrowser())
...
function restart(){slideshow.playHandler=null;$('pausebutton').style.display='';$('playbutton').src=browser.supportsPNGs?baseURL+'play.svg':baseURL+'images/play.gif';$('playbutton').style.display='none';if($('controls').getOpacity()>0.05)
